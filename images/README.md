...
5. Configure PTP, the configuration varies for the interface name and the NICs that support hardware PTP and NICs that do not.
6. Configure the RT kernel to make ptp the highest priority.
